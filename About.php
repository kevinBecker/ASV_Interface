      ...
      <div class="u-clearfix u-sheet u-sheet-1">
        <div class="u-container-style u-group u-group-1">
          <div class="u-container-layout u-valign-middle u-container-layout-1">
            <h2 class="u-text u-text-default u-text-1">About The&nbsp; Webb Institute&nbsp; ASV</h2>
            <p class="u-text u-text-2"> This project is a continuation of multiple student's theses.&nbsp;<br>
              <br>In 2016 the project began with Issac Kremers designing and constructing the model and writing code. Back then, the vessel only used an arduino, so the code was written in C++.&nbsp;<br>
              <br>In 2018 this project was continued by Nicholas Ratinaud who re-wrote the code for path following.<br>
              <br>In 2020 and 2021, Max Haland added a Raspberry Pi for the main computer to allow for more advanced algorithms and improved connectivity. The arduino is still utilized to provide real time response to control the hardware.<br>
              <br>Currently, the project is being worked on by Kevin Becker
            </p>
            <a href="https://github.com/mabster314/JavaASV/" class="u-active-none u-border-2 u-border-palette-1-base u-btn u-btn-rectangle u-button-style u-hover-none u-none u-btn-1">Source Code</a>
          </div>
        </div>
      </div>
    </section>
