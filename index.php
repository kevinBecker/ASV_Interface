...
border-color: #404040 !important; border-width: 2px !important; borders: top right bottom left !important
    ...
    <section class="u-align-center u-clearfix u-section-1" id="sec-25a2">
      <div class="u-clearfix u-sheet u-sheet-1">
        <h2 class="u-text u-text-custom-color-1 u-text-1">GPS Coordinates</h2>
        <div class="u-form u-form-1">
          <form action="#" method="POST" class="u-clearfix u-form-spacing-10 u-form-vertical u-inner-form" source="custom" name="form" style="padding: 10px;">

            <div class="u-form-group u-form-partition-factor-2 u-form-group-1">
              <label for="text-7b73" class="u-form-control-hidden u-label"></label>
              <input type="text" placeholder="Longitude 1" id="text-7b73" name="Long1" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-radius-50 u-white u-input-1" required="required">
            </div>
            <div class="u-form-group u-form-partition-factor-2 u-form-group-2">
              <label for="text-4dd7" class="u-form-control-hidden u-label"></label>
              <input type="text" placeholder="Latitude 1" id="text-4dd7" name="Lat1" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-radius-50 u-white u-input-2" required="required">
            </div>
            <div class="u-form-group u-form-partition-factor-2 u-form-group-3">
              <label for="text-6fe7" class="u-form-control-hidden u-label"></label>
              <input type="text" placeholder="Longitude 2" id="text-6fe7" name="Long2" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-radius-50 u-white u-input-3" required="required">
            </div>
            <div class="u-form-group u-form-partition-factor-2 u-form-group-4">
              <label for="text-b8e6" class="u-form-control-hidden u-label"></label>
              <input type="text" placeholder="Latitude 2" id="text-b8e6" name="Lat2" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-radius-50 u-white u-input-4" required="required">
            </div>
            <div class="u-form-group u-form-partition-factor-2 u-form-group-5">
              <label for="text-4329" class="u-form-control-hidden u-label"></label>
              <input type="text" placeholder="Longitude 3" id="text-4329" name="Long3" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-radius-50 u-white u-input-5">
            </div>
            <div class="u-form-group u-form-partition-factor-2 u-form-group-6">
              <label for="text-2bd2" class="u-form-control-hidden u-label"></label>
              <input type="text" placeholder="Latitude 3" id="text-2bd2" name="Lat3" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-radius-50 u-white u-input-6">
            </div>
			</form>
			<div class="u-align-center u-form-group u-form-submit">
              <a href="#" class="u-btn u-btn-round u-btn-submit u-button-style u-radius-50">Start ASV<br>
              </a>
